...
class DehazeNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1_0 = nn.Conv2d(in_channels=3, out_channels=32, kernel_size=1, stride=1, padding=0, bias=True)
        ...
        self.conv2 = nn.Conv2d(in_channels=3, out_channels=128, kernel_size=1, stride=1, padding=0, bias=True)
        self.convT = nn.ConvTranspose2d(in_channels=128, out_channels=32, kernel_size=6, stride=4, padding=1, bias=True)
        self.conv3 = nn.Conv2d(64, 3, 5, 1, 2, bias=True, padding_mode='replicate')
