...
# Input Parameters
parser.add_argument('--orig_images_path', type=str, default="new-architecture/net2/Haze4K/train/gt/")
parser.add_argument('--hazy_images_path', type=str, default="new-architecture/net2/Haze4K/train/haze/")
...
parser.add_argument('--snapshots_folder', type=str, default="new-architecture/net2/snapshots2-1/")
