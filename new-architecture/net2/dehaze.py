...
# 拟合程度验证
# parser.add_argument('--dehaze_dir', default='new-architecture/net2/Haze4K/train/dehaze')
# parser.add_argument('--original_dir', default='new-architecture/net2/Haze4K/train/gt')
# parser.add_argument('--haze_dir', default='new-architecture/net2/Haze4K/train/haze')
# parser.add_argument('--result_file', default=f'new-architecture/net2/result2-0.csv')
# parser.add_argument('--test_length', default=3000)
# nohup python new-architecture/net2/dehaze.py  >> new-architecture/net2/dehaze-5-10-net2-0.out &
# PID 13458 14403

# 普通测试与泛化测试
parser.add_argument('--dehaze_dir', default='new-architecture/net2/Haze4K/test/dehaze')
parser.add_argument('--original_dir', default='new-architecture/net2/Haze4K/test/gt')
parser.add_argument('--haze_dir', default='new-architecture/net2/Haze4K/test/haze')
parser.add_argument('--result_file', default=f'new-architecture/net2/result2-1-1.csv')
parser.add_argument('--test_length', default=1000)
# nohup python new-architecture/net2/dehaze.py  >> new-architecture/net2/dehaze-5-10-net2-1.out &

# parser.add_argument('--dehaze_dir', default='new-architecture/net2/data/dehaze')
# parser.add_argument('--original_dir', default='new-architecture/net2/data/images')
# parser.add_argument('--haze_dir', default='new-architecture/net2/data/data')
# parser.add_argument('--result_file', default='new-architecture/net2/result2-2.csv')
# parser.add_argument('--test_length', default=3000)
# nohup python new-architecture/net2/dehaze.py  >> new-architecture/net2/dehaze-5-10-net2-2.out &

parser.add_argument('--sample_dir', default='new-architecture/net2/samples2/')
parser.add_argument('--snapshot_model_dir_or_file', default='new-architecture/net2/snapshots2-1/DehazeNet_epoch7.pth')
# parser.add_argument('--snapshot_model_dir_or_file', default=f'new-architecture/net2/snapshots2/DehazeNet_epoch199.pth')
# parser.add_argument('--snapshot_model_dir_or_file', default='new-architecture/net2/snapshots2/DehazeNet_epoch123.pth')
# parser.add_argument('--snapshot_model_dir_or_file', default='new-architecture/net2/record-snapshots2/DehazeNet_epoch198.pth')
