...
# 拟合程度验证
# parser.add_argument('--dehaze_dir', default='new-architecture/net3/Haze4K/train/dehaze')
# parser.add_argument('--original_dir', default='new-architecture/net3/Haze4K/train/gt')
# parser.add_argument('--haze_dir', default='new-architecture/net3/Haze4K/train/haze')
# parser.add_argument('--result_file', default=f'new-architecture/net3/result3-0.csv')
# parser.add_argument('--test_length', default=3000)
# nohup python new-architecture/net3/dehaze.py  >> new-architecture/net3/dehaze-5-9-net3-0.out &
# PID 29300 30899 

# 普通测试与泛化测试
parser.add_argument('--dehaze_dir', default='new-architecture/net3/Haze4K/test/dehaze')
parser.add_argument('--original_dir', default='new-architecture/net3/Haze4K/test/gt')
parser.add_argument('--haze_dir', default='new-architecture/net3/Haze4K/test/haze')
parser.add_argument('--result_file', default=f'new-architecture/net3/result3-1.csv')
parser.add_argument('--test_length', default=1000)
# nohup python new-architecture/net3/dehaze.py  >> new-architecture/net3/dehaze-5-9-net3-1.out &

# parser.add_argument('--dehaze_dir', default='new-architecture/net3/data/dehaze')
# parser.add_argument('--original_dir', default='new-architecture/net3/data/images')
# parser.add_argument('--haze_dir', default='new-architecture/net3/data/data')
# parser.add_argument('--result_file', default='new-architecture/net3/result3-2.csv')
# parser.add_argument('--test_length', default=3000)
# nohup python new-architecture/net3/dehaze.py  >> new-architecture/net3/dehaze-5-9-net3-2.out &

parser.add_argument('--sample_dir', default='new-architecture/net3/samples3/')
parser.add_argument('--snapshot_model_dir_or_file', default='new-architecture/net3/snapshots3')
# parser.add_argument('--snapshot_model_dir_or_file', default=f'new-architecture/net3/snapshots3/DehazeNet_epoch199.pth')
# parser.add_argument('--snapshot_model_dir_or_file', default='new-architecture/net3/snapshots3/DehazeNet_epoch123.pth')
# parser.add_argument('--snapshot_model_dir_or_file', default='new-architecture/net3/record-snapshots3/DehazeNet_epoch198.pth')
    ...
    try:
        if os.path.isfile(snapshot_model_dir_or_file):
            ...
            for snapshot_model in sorted(os.listdir(snapshot_model_dir_or_file), key=lambda name: int(name.split('.')[0][15:])):
                ...
                # 分析结果并输出到csv文件
                avg_psnr, avg_ssim = dataAnalysis(haze_dir, original_dir, dehaze_dir)
                df.loc[len(df)] = {'net': f'net3', 'epoch': snapshot_model_index, 'model': snapshot_model, 'avg_psnr': avg_psnr,
                                   'avg_ssim': avg_ssim}
                print(f"[{datetime.datetime.now()}] Avg_PSNR: {avg_psnr} dB, Avg_SSIM: {avg_ssim}")
                # 测试专用
                # if idx >= 2:
